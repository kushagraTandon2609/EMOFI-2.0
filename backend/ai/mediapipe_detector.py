    ...
    with holistic.Holistic(
        ...
        if result.left_hand_landmarks:
            ...
            for point in result.left_hand_landmarks.landmark:
                features.append(
                    point.x - result.left_hand_landmarks.landmark[8].x
                )
                features.append(
                    point.y - result.left_hand_landmarks.landmark[8].y
                )
        ...
        if result.right_hand_landmarks:
            ...
            for point in result.right_hand_landmarks.landmark:
                features.append(
                    point.x - result.right_hand_landmarks.landmark[8].x
                )
                features.append(
                    point.y - result.right_hand_landmarks.landmark[8].y
                )
